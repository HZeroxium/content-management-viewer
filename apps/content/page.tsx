...
export default function ContentPage() {
  ...
  const getContentExcerpt = (content: ContentResponseDto, maxLength = 120): string => {
          ...
          {viewMode === "grid" && (
            <Grid container spacing={3}>
              {data.data.map((content, index) => (
                ...
                >
                  <Link href={`/content/${content.id}`} style={{ textDecoration: "none" }}>
                    <Card 
                      sx={{ 
                        height: "100%", 
                        display: "flex", 
                    ...
                    >
                      ...
                      <CardContent sx={{ flexGrow: 1, display: "flex", flexDirection: "column" }}>
                        ...
                        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mt: 1 }}>
                          <Tooltip title={`Published on ${formatDate(content.createdAt || "")}`}>
